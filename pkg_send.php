											...
											<td width="*" class="hei" align="left" valign="top">
				                                ...
				                                <span id="txtShowContent"></span><table class="hei" cellspacing="1" cellpadding="2" width="100%" bgcolor="#3ac3a7" border="0" valign="middle">
				                                 ...
				                                 <?php 
											   	...
											   	<tr class="row0" bgcolor="#ffffff"><td nowrap="" align="center" height="26"><?php echo $row['pack_id']?> </td><td nowrap="" align="center" height="26"><?php echo $row['delivermethod']?></td><td nowrap="" align="center" height="26"><?php echo $row['tracknumber']?></td><td nowrap="" align="center" height="26"><?php echo $row['pack_weight']?></td><td nowrap="" align="center" height="26"><?php echo $row['storage']?></td><td nowrap="" align="middle" height="26"><?php echo $row['pack_date']?></td><td nowrap="" align="center" height="26"><a href="Us_Mybusiness_Add.aspx?ID=8802"><b><?php echo $row['cid']?></b></a></td><td nowrap="" align="center" height="26"></td><td nowrap="" align="center" height="26"><a href="Us_PackageList_Add.aspx?ID=14606">添加备注</a>&nbsp;<a href='javascript:if(confirm("您确认提交此包裹-拍照申请-吗？"))  window.location.href="Us_PackageListPhotoAdd.aspx?action=add&pkid=14606"'>拍照</a>&nbsp;<a href='javascript:if(confirm("您确认提交此包裹-退货申请-吗？"))  window.location.href="Us_PackageListReturnAdd.aspx?action=add&pkid=14606"'>退货</a></td></tr>
				                            	<?php   
												  		}
				                                 	}
				                                ?>
